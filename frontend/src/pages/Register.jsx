        ...
        <section className='p-5'>
            <div className='my-24 max-w-xl mx-auto p-5 rounded-xl custom-shadow'>
                ...
                <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
                    ...
                    <button type='submit' disabled={loading} className={'btn btn-primary text-lg'}>Register</button>
                </form>
                <p className='mt-5'>Already have an account ? <Link to={"/login"} className='underline text-blue-500'>Login</Link> </p>
            </div>
        </section>
    )
}
